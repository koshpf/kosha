...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dbx71Wjl.mjs");
...
var manifest = {
	"7d1edf2a6c56c64fb0d012a74a988e16eba249b93eaa17cac596f3d91f9969c1": {
		functionName: "searchMutualFunds_createServerFn_handler",
		importer: () => import("./quotes-D2iqdu10.mjs")
	},
	"9d517c9f904e61b744a3f138aaf2b00d752a017c8d627f33386606b4cd7f7947": {
		functionName: "fetchMarketQuotes_createServerFn_handler",
		importer: () => import("./quotes-D2iqdu10.mjs")
	},
	"b23621a74cd47c1d46b54a639d79ce4b21dd9703d8b8fdba856fa54c7f3ffcfd": {
		functionName: "searchTickers_createServerFn_handler",
		importer: () => import("./quotes-D2iqdu10.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CUJh-yqh.mjs").then((n) => n.t),
